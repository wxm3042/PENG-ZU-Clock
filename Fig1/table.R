...
show_fea_path <- 'output/0.figure/figure1/show_fea.xlsx'
...
labels$groups <- c("CS", "BJ", "")

strata <- c(split(all_dat_use, all_dat_use$pt_type), list(Overall=all_dat_use))
...
# Save the document
print(doc, target = paste0(outpath, "table_output.docx"))
