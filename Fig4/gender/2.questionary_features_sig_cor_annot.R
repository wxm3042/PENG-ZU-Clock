...
dat_path_list <- c(
  male = 'V20250427/output/Fig4/gender/male_questionary_features_cor_with_delta_age_all.xlsx',
  female='V20250427/output/Fig4/gender/female_questionary_features_cor_with_delta_age_all.xlsx'
)
