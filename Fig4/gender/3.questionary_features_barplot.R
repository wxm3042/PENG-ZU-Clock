...
dat_path_list <- c(
  male = 'V20250427/output/Fig4/gender/male_questionary_features_sig_cor_annot.xlsx',
  female = 'V20250427/output/Fig4/gender/female_questionary_features_sig_cor_annot.xlsx'
)
...
for(g in names(dat_path_list)){
  ...
  ggsave(
    filename = paste0(outpath, g, '_sig_questionary_features_barplot.pdf'),
    plt,
    width = 8,
    height = 14
  )
