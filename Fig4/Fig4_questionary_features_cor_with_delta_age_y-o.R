...
outpath <- 'output/3.clock/changsha_clock/elastic_net_scale/merge_bj_cs/young-vs-old_delta_age_related_features/'
...
for(g in young_old_list){
  ...
  write.xlsx(
    res_df,
    paste0(outpath, g, '_questionary_features_cor_with_delta_age_all.xlsx')
  )
  ...
  write.xlsx(
    sig_res,
    paste0(outpath, g, '_questionary_features_cor_with_delta_age.xlsx')
  )
