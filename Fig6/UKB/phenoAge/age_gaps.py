# -*- coding: utf-8 -*-
"""
Created on Wed Apr  9 14:48:52 2025
...
age_data_path = '..\\00database\\UKB\\output\\feature\\phenoAge.txt'

outpath = 'V20250427\\output\\Fig6\\UKB\\phenoAge\\'


# Step 1: Initialize arrays to store age gaps and z-scored age gaps
age_df_raw = pd.read_csv(age_data_path)[['eid', 'Age', 'phenoage']]
age_df = age_df_raw.sort_values(by='Age')

predicted_ages = age_df['phenoage'].values
