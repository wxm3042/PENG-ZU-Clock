...
ic_path <- 'data/ic_score_all.xlsx'
age_gaps_path <- 'output/3.clock/changsha_clock/elastic_net_scale/simplify_clock/merge/age_gaps_with_disease.xls'
