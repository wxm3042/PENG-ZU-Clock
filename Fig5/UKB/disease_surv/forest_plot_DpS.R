...
dat_path <- 'V20250427/output/Fig5/UKB/disease_surv/disease_HR_df_sig.xls'
...
ggsave(
  filename = paste0(outpath, 'sig_DPS_risk_part1.pdf'),
  plt,
  width = 22,
  height = HT
)
...
ggsave(
  filename = paste0(outpath, 'sig_DPS_risk_part2.pdf'),
  plt,
  width = 3,
  height = HT
)
